...
\textbf{\begin{tabular}[c]{@{}l@{}}Feature \\ Name\end{tabular}}   & From                                                     & Elog                                                     & Conv                                                     & Solid                                                       & \begin{tabular}[c]{@{}l@{}}mean \\ Red\end{tabular} \\ \hline
...
\textbf{\begin{tabular}[c]{@{}l@{}}Feature \\ Name\end{tabular}}   & \begin{tabular}[c]{@{}l@{}}Mean \\ green\end{tabular}    & \begin{tabular}[c]{@{}l@{}}Mea \\ blue\end{tabular}      & \begin{tabular}[c]{@{}l@{}}std \\ Red\end{tabular}       & \begin{tabular}[c]{@{}l@{}}Std \\ green\end{tabular}        & \begin{tabular}[c]{@{}l@{}}Std \\ blue\end{tabular} \\ \hline
...
\section{Results from using Neural Networks}
